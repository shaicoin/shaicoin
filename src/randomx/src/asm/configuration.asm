...
RANDOMX_ARGON_SALT TEXTEQU <"ShaicoinRandomX-v2\x01">
...
RANDOMX_FREQ_IROR_R EQU 5t
RANDOMX_FREQ_IROL_R EQU 5t
RANDOMX_FREQ_ISWAP_R EQU 4t
RANDOMX_FREQ_FSWAP_R EQU 4t
RANDOMX_FREQ_FADD_R EQU 17t
RANDOMX_FREQ_FADD_M EQU 4t
RANDOMX_FREQ_FSUB_R EQU 15t
RANDOMX_FREQ_FSUB_M EQU 6t
