...
const QString BITCOIN_IPC_PREFIX("shaicoin:");
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("shaicoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'shaicoin://' is not a valid URI. Use 'shaicoin:' instead."),
